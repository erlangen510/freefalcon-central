...
DigitalBrain::BVRProfileType BvrLookup[] = {
    DigitalBrain::Plevel1a,      DigitalBrain::Plevel2a,
    DigitalBrain::Plevel3a,      DigitalBrain::Plevel1b,
    DigitalBrain::Plevel2b,      DigitalBrain::Plevel3b,
    DigitalBrain::Plevel1c,      DigitalBrain::Plevel2c,
    DigitalBrain::Plevel3c,      DigitalBrain::Pbeamdeploy,
    DigitalBrain::Pbeambeam,     DigitalBrain::Pwall,
    DigitalBrain::Pgrinder,      DigitalBrain::Pwideazimuth,
    DigitalBrain::Pshortazimuth, DigitalBrain::PwideLT,
    DigitalBrain::PShortLT,      DigitalBrain::PDefensive};
...
void DigitalBrain::ReceiveOrders(FalconEvent *theEvent)
{
    ...
    if (curMode == GunsJinkMode or curMode == MissileDefeatMode or
        curMode == DefensiveModes)
    {
        ...
        case FalconWingmanMsg::WMDecreaseRelAlt:
            ...
            case FalconWingmanMsg::WMRejoin:
                AiRejoin(
                    wingMsg,
                    AI_REJOIN); // 2001-10-23 ADDED AI_REJOIN BY S.G. So the AI knows it comes from the lead
                //underOrders = FALSE;
                break;
        ...
        case FalconWingmanMsg::WMPDefensive:
            if (flightLead and ((AircraftClass *)flightLead)->DBrain())
                ((AircraftClass *)flightLead)
                    ->DBrain()
                    ->SetBvrCurrProfile(
                        BvrLookup[command - FalconWingmanMsg::WMPlevel1a]);
