...
static int randIntTab5[16] = {
    0, 1, 0, 2, 4, 0, 2, 0, 3, 0, 4, 0, 4, 1, 0, 3,
};
...
static float randFloatTab[16] = {0.7f,  -0.6f, -0.9f, 0.8f, 0.1f,  0.5f,
                                 -0.3f, -0.6f, 1.0f,  0.2f, -0.8f, 0.3f,
                                 -1.0f, 0.8f,  -0.4f, 0.3f};
...
static float randFloatTabPos[16] = {0.7f, 0.6f, 0.1f, 0.8f, 0.1f, 0.5f,
                                    0.3f, 0.6f, 1.0f, 0.2f, 0.8f, 0.1f,
                                    0.0f, 0.2f, 0.9f, 0.4f};
...
static int randIntTab6[16] = {
    0, 1, 5, 2, 4, 3, 2, 0, 3, 2, 4, 5, 4, 1, 0, 3,
};
